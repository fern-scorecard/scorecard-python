...
Then take a look at the log file `tracer.log` in the top level directory.

## Done
- [x] Basic tracing

## Todo
- [?] Integrate with Scorecard DB
- [?] Battle test the tracing
    - [x] Multiple threads? (@huyouare, thoughts?)
    - [x] Replays
    - [x] Automatic test set creation
    - [?] Multiple processes? (@houyouare, thoughts?)
- [ ] Unit testing
